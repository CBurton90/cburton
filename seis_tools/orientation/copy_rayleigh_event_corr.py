...
st.trim(starttime=t1+5, endtime=t1+duration-5)
...
fig.suptitle('T120-BH1 orientation at URZ with event us7000eakj (USGS)', fontsize=18)
...
m = Basemap(llcrnrlon=165.,llcrnrlat=-50.,urcrnrlon=180.,urcrnrlat=-25.,\
...
ax1.set_title('5.7 Mww to URZ (2021-06-06T23:16:40)', pad=10)
...
# fig.tight_layout()
plt.show()
# plt.savefig('T120-BH1_orient_URZ_us7000eakj.png', format='PNG', dpi=400)
